...
Vertices ui and vi are connected by an edge with weight wi.
You are given m queries. 
The i-th query is given as an integer qi. 
...
/*
Hint:
* sort the queries and edges
* Pairs which are valid for qi = 2 are also valid for qj = 3
* Try utilizing DSU
*/
