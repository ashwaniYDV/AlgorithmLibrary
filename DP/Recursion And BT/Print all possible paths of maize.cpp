// Print all possible paths from top left to bottom right of a mXn maize
...
void solveMaze(vector<vector<ll>>& maize, ll x, ll y, ll destX, ll destY, vector<vector<ll>>& visited){
	...
	solveMaze(maize, x+1, y, destX, destY, visited);
	solveMaze(maize, x, y+1, destX, destY, visited);
