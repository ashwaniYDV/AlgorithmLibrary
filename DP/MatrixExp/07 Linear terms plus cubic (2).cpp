...
Special Sequence
---------------------------------------
F[n] = 4*F[n-1] + 3*F[n-2] + 5*n^3 + 9*n^2 + 7*n + 3

Given:
F[0] = 1, F[1] = 2

|   F[n]   |  =  | 4 3 5 9 7 3 | | F[n-1] |
|  F[n-1]  |  =  | 1 0 0 0 0 0 | | F[n-2] |
| (n+1)^3  |  =  | 0 0 1 3 3 1 | |   n^3  |
| (n+1)^2  |  =  | 0 0 0 1 2 1 | |   n^2  |
|   (n+1)  |  =  | 0 0 0 0 1 1 | |    n   |
|     1    |  =  | 0 0 0 0 0 1 | |    1   |

|   F[n]   |  =  | 4 3 5 9 7 3 |^(n-1) | F[1] |
|  F[n-1]  |  =  | 1 0 0 0 0 0 |       | F[0] |
| (n+1)^3  |  =  | 0 0 1 3 3 1 |       |  n^3 |
| (n+1)^2  |  =  | 0 0 0 1 2 1 |       |  n^2 |
|  (n+1)   |  =  | 0 0 0 0 1 1 |       |   n  |
|    1     |  =  | 0 0 0 0 0 1 |      .|   1  |

|   F[n]   |  =  | 4 3 5 9 7 3 |^(n-1) |   2  |
|  F[n-1]  |  =  | 1 0 0 0 0 0 |       |   1  |
| (n+1)^3  |  =  | 0 0 1 3 3 1 |       |  n^3 |
| (n+1)^2  |  =  | 0 0 0 1 2 1 |       |  n^2 |
|  (n+1)   |  =  | 0 0 0 0 1 1 |       |   n  |
