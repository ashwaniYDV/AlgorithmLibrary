...
void solve() {
    ...
    cin >> a >> b >> c;
    // a*x + b*y = c
    cout << find_all_solutions(a, b, c, 0, c/a, 0, c/b) << endl;
    // cout << find_all_solutions(a, b, c, 0, 1e9, 0, 1e9) << endl;
}
...
// Method 2: Efficient for number of non negative solutions of equation [ax+by=d] 
// https://youtu.be/gFgRYepIXDY
